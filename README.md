...
[![My Skills](https://skillicons.dev/icons?i=java,js,ts,kotlin,linux,androidstudio,react,nodejs,mongodb,express,npm,postman,vite,vscode,angular,aws,bootstrap,c,cpp,css,tailwind,docker,eclipse,firebase,git,github,html,php,mysql,idea,spring,r,figma&theme=dark)](https://skillicons.dev)
